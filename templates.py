text_templates = {
	...
	'2-1': '제7회 전국동시지방선거가 13일 오전 6시를 기해 전국의 투표소에서 시작되었으며, {hour} 이전국 투표율은 {toorate_avg_nat}%로 집계되었다.', # 투표중
	...
	# 20: '득표율 특이사항',
	'20-1': '{region} 지역의 {poll} 선거에서 현재 {poll}인 {current_name} 후보가 탈락의 고배를 마셨다. {current_name} 후보는 {rank1_name} 후보에게 {diff_percent}% 포인트 차이로 패하며 연임에 실패했다.',

	'20-2': '{region} 지역의 {poll} 선거에서 현재 {poll}인 {current_name} 후보가 재선에 성공했다. {current_name} 후보는 2위인 {rank2_name} 후보에게 {diff_percent}% 포인트 차이로 승리하며 연임에 성공했다.',
	...
	'20-33': '제 7회 지방선거에 단독 정당을 처음으로 출정한 바른미래당은 {hour} 현재, 시도지사 선거에서는 {sido_rank1_party_num}개, 시군구청장 선거에서는 {gusigun_rank1_party_num}개의 선거구에서 1위를 달리고 있다. 과연 충분한 성과를 얻어 원내 3당의 입지를 확고히 할 수 있을지 귀추가 주목된다.',
...
# 당선이 확정되었습니다.'
	...
	'22-20': '제7대 지방선거의 투표율은 {toorate_avg_nat}로 역대 지방선거 투표율 중 가장 높았던 1995년 제1회 지방선거의 투표율인 68.4%를 넘어 국민들의 이번 선거에 대한 뜨거운 관심을 보여주고 있다.',
	'22-21': '오후 6시 투표를 마감한 결과, 전국 {선거인수.전국}명의 유권자 중 {투표자수.전국}명이 투표에 참여한 것으로 잠정 집계됐다. 이번 지방선거를 통해 당선된 당선자들의 임기는 총 4년(2018.7.1.~2022.6.30.)이다.',
	...
	'22-23': '투표 마감 결과, 가장 투표율이 높은 지역은 시도 단위에서는 {지역명.최종투표율.시도지사.순위1}{이며|며}, 시군구 단위에서는 {지역명.최종투표율.시군구청장.순위1}{으로|로} 나타났다.',
	'22-24': '제 7회 지방선거에서 선거인수가 가장 많은 곳은 {지역명.시도지사.선거인수.순위1}{으로|로} 총 {선거인수.순위1}명이 이번 지방선거 선거인 명부에 등재되었다. 해당 지역의 투표율은 {투표율.시도지사.선거인수.순위1}% 이다.',
	'22-25': '제 7회 지방선거에서 선거인수가 가장 적은 곳은 {지역명.시군구청장.선거인수.순위226}{으로|로} 총 {선거인수.순위226}명이 이번 지방선거 선거인 명부에 등재되었다. 해당 지역의 투표율은 {투표율.시군구청장.선거인수.순위226}% 이다.',
	...
	'22-3': '이번 지방선거에는 총 426억여원의 보조금이 지급되었다. 정당별로 배분된 선거보조금은 자유한국당이 137억 6430만원, 더불어민주당이 135억 3834만원, 바른미래당이 98억 8386만원, 민주평화당과 정의당이 각각 25억 4930만원과 27억 1033만원이다. 선거 보조금 총액은 선거권자 총수를 기준으로 결정되며, 선거 보조금 배분은 지난 총선에서 각 정당이 얻은 득표율을 기준으로 한다.',
