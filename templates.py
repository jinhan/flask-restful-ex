...
text_templates = {
	...
	7: '{hour} 현재 {region1} 지역 전체의 개표율은 {openrate_region1}%로 전국 평균보다 약 {openrate_region1_openrate_avg_nat}% 포인트 {compare_region1} 수치이며, {region2}는 {openrate_region2}%로 전국 평균보다 {compare_region2} 개표율을 보였다. 전국에서 가장 개표가 빠른 지역은 {openrate_sido_rank1}이며, {region1}지역에서 개표가 가장 빠른 곳은 {openrate_region1_rank1_name}로 {openrate_region1_rank1}%의 개표율을 보이고 있다.',
	# {현재 시간.시각} 현재 {관심지역1} 지역 전체의 개표율은 {개표율.관심지역1}%로 {아직 개표가 시작되지 않았다.| 전국 평균보다 약 {개표율.전국.평균 - 개표율.관심지역1}% 포인트 {높은|낮은} 수치이며,} {관심지역2}는 {개표율.관심지역2}%로 {아직 개표가 시작되지 않았다.| 전국 평균보다 {높은|낮은} 개표율을 보였다.
