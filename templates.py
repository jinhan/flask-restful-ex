text_templates = {
	...
	20: '득표율 특이사항',
	'20-10': '{지역명.정당교체.당선확정} 지역의 {선거명.정당교체.당선확정} 선거에서 현재 {시장|도지사|시장|구청장|군수}인 {정당명.정당교체.현직}이 탈락의 고배를 마셨다. {정당명.정당교체.현직}의 {후보명.정당교체.현직} 후보는 {정당명.정당교체.당선확정}의 {후보명.정당교체.당선확정} 후보에게 {득표율.정당교체.당선확정 - 득표율.정당교체.현직}% 포인트 차이로 패하며 자당의 단체장 자리 수성에 실패했다.',
	'20-11': '지난 2014년 6회 시도지사 선거에서는 새누리당이 {최종득표율.시도지사.새누리당}%, 새천년 민주당이 {최종득표율.시도지사.새천년민주당}%, 통합진보당이 {최종득표율.시도지사.통합진보당}%의 득표율을 획득했다. 제 7회 시도지사 선거가 진행되고 있는 오늘 {현재 시간.시각} 현재 더불어 민주당은 {현재득표율.시도지사.민주당}%, 자유한국당은 {현재득표율.시도지사.자유당}%, 바른미래당{현재득표율.시도지사.바미당}%를 획득하고 있다.',

	'20-12': '제 7회 지방선거에 단독 정당을 처음으로 출정한 바른미래당은 {현재 시간.시각} 현재, 시도지사 선거에서는 {선거구 수.바미당.전국.시도지사.순위1}개, 시군구청장 선거에서는 {선거구 수.바미당.전국.시군구청장.순위1}개의 선거구에서 1위를 달리고 있다. 과연 충분한 성과를 얻어 원내 3당의 입지를 확고히 할 수 있을지 귀추가 주목된다.',
